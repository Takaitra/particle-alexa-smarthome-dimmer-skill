 ...
 * See https://github.com/alexa/skill-sample-nodejs-smarthome-switch/blob/master/lambda/smarthome/alexa/skills/smarthome/AlexaResponse.js
 * @class
 */
class AlexaResponse {
  /**
  ...
  constructor(opts) {
    ...
    if (opts.context !== undefined) this.context = this.checkValue(opts.context, undefined);

    if (opts.event !== undefined) this.event = this.checkValue(opts.event, undefined);
    else {
      this.event = {
        header: {
    ...
    if (this.event.header.name === 'AcceptGrant.Response' || this.event.header.name === 'Discover.Response') delete this.event.endpoint;
  }
